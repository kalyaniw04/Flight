...
public class FlightPage3 extends BasePage {

	public FlightPage3(WebDriver driver) {
		super(driver);
    ...
    @FindBy(xpath="(//li[@data-value='p'])[1]")
    WebElement pre;
    public void ClickpreAction() {
    	clickAction(pre);
    }
    ...
    @FindBy(xpath="//label[text()='Nonstop']")
    WebElement nonstop ;
